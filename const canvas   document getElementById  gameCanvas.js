...
// === Earth (colored, no texture) ===
const earthGeo = new THREE.SphereGeometry(5, 128, 128);
const earthMat = new THREE.MeshStandardMaterial({ color: 0x2266cc, roughness: 1, metalness: 0 });
const earth = new THREE.Mesh(earthGeo, earthMat);
scene.add(earth);

// Optional: fake continents
const landGeo = new THREE.SphereGeometry(5.01, 128, 128);
const landMat = new THREE.MeshStandardMaterial({ color: 0x228833, transparent:true, opacity:0.3 });
